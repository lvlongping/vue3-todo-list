...
var drawerProps = function drawerProps() {
  return {
    ...
    wrapStyle: _vueTypes.default.style,
    ...
    contentWrapperStyle: _vueTypes.default.object,
    ...
    footerStyle: _vueTypes.default.object,
    level: _vueTypes.default.any,
    levelMove: _vueTypes.default.any,
...
var Drawer = (0, _vue.defineComponent)({
  ...
  setup: function setup(props, _ref) {
    ...
    var renderCloseIcon = function renderCloseIcon(prefixCls) {
      ...
      var closable = props.closable;
      var $closeIcon = props.closeIcon ? (_a = slots.closeIcon) === null || _a === void 0 ? void 0 : _a.call(slots) : props.closeIcon;
    ...
    return function () {
      ...
      var vcDrawerProps = (0, _extends2.default)((0, _extends2.default)((0, _extends2.default)((0, _extends2.default)({}, attrs), (0, _omit.default)(rest, ['size', 'closeIcon', 'closable', 'destroyOnClose', 'drawerStyle', 'headerStyle', 'bodyStyle', 'title', 'push', 'wrapStyle'])), val), {
        onClose: close,
