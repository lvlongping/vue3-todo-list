...
var _default = (0, _vue.defineComponent)({
  ...
  setup: function setup(props, _ref) {
    ...
    var filledTagOptions = (0, _vue.computed)(function () {
      if (props.mode !== 'tags') {
        return mergedOptions.value;
      } // >>> Tag mode


      var cloneOptions = (0, _toConsumableArray2.default)(mergedOptions.value); // Check if value exist in options (include new patch item)
    ...
    var triggerChange = function triggerChange(values) {
      ...
      labeledValues.length !== mergedValues.value.length || labeledValues.some(function (newVal, index) {
        ...
        var returnValues = props.labelInValue ? labeledValues : labeledValues.map(function (v) {
          return v.value;
        });
