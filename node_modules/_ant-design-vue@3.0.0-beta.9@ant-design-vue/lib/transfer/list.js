...
var transferListProps = {
  ...
  remove: _vueTypes.default.string,
  selectAll: _vueTypes.default.string,
  selectCurrent: _vueTypes.default.string,
  selectInvert: _vueTypes.default.string,
  removeAll: _vueTypes.default.string,
  removeCurrent: _vueTypes.default.string,
  selectAllLabel: _vueTypes.default.any,
  showRemove: _vueTypes.default.looseBool,
  pagination: _vueTypes.default.any,
  onItemSelect: _vueTypes.default.func,
  onItemSelectAll: _vueTypes.default.func,
  onItemRemove: _vueTypes.default.func,
...
var _default2 = (0, _vue.defineComponent)({
  ...
  setup: function setup(props, _ref) {
    ...
    var getCheckBox = function getCheckBox(showSelectAll, disabled, prefixCls) {
    ...
    return function () {
      ...
      }, [checkAllCheckbox, dropdown, (0, _vue.createVNode)("span", {
