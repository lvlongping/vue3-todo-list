...
var _default = (0, _vue.defineComponent)({
  ...
  setup: function setup(props, _ref) {
    ...
    var deDuplicatedValues = (0, _vue.computed)(function () {
      ...
      var deduplicateKeys = (0, _treeUtil.formatStrategyValues)(checkedKeys, pathKeyEntities.value);
      ...
      if (!multiple.value) {
        ...
        if (existInMissing && !existInChecked) {
          ...
          if (existInChecked) {
            ...
            var _conductCheck3 = (0, _conductUtil.conductCheck)(nextRawCheckedKeys, true, pathKeyEntities.value);

            checkedKeys = _conductCheck3.checkedKeys;
          } // Roll up to parent level keys


          var deDuplicatedKeys = (0, _treeUtil.formatStrategyValues)(checkedKeys, pathKeyEntities.value);
