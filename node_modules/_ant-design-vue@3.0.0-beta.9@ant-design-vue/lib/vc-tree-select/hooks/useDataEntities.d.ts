...
declare const _default: (treeData: Ref<any>, fieldNames: Ref<FieldNames>) => {
    valueEntities: Ref<Map<RawValueType, DataEntity<import("../../vc-tree/interface").DataNode>>>;
    keyEntities: Ref<{
        [x: string]: {
            node: {
                [x: string]: any;
            ...
            children?: any[];
            level: number;
            key: import("../../vc-tree/interface").Key;
            index: number;
            pos: string;
        };
    }>;
