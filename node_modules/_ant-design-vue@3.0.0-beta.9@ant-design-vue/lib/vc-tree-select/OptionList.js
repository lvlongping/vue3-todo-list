  ...
  setup: function setup(_, _ref) {
    ...
    (0, _vue.watch)(function () {
      ...
      if (baseProps.searchValue) {
        searchExpandedKeys.value = (0, _valueUtil.getAllKeys)(context.treeData, context.fieldNames);
      }
    }, {
      immediate: true
    });
    var mergedExpandedKeys = (0, _vue.computed)(function () {
      if (legacyContext.treeExpandedKeys) {
        return (0, _toConsumableArray2.default)(legacyContext.treeExpandedKeys);
      }
      ...
      onKeydown: function onKeydown(event) {
        ...
        switch (which) {
          ...
          case _KeyCode.default.ENTER:
            {
              var _ref3 = ((_b = activeEntity.value) === null || _b === void 0 ? void 0 : _b.node) || {},
